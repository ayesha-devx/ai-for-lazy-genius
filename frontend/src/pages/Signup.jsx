    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-zinc-400 mt-2">Join the community of modern AI enthusiasts</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center py-3 px-4 mt-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-lg shadow-indigo-500/30 transition-all disabled:opacity-70 disabled:cursor-not-allowed active:scale-[0.98]"
          >
